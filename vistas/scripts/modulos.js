...
function listar()
{
	tabla=$('#tbllistado').DataTable(
	{
      ...
      lengthMenu:     "Mostrando _MENU_ modulos",
      info:           "Mostrando del _START_ al _END_ de _TOTAL_ modulos",
...
{
	$.post("../ajax/modulos.php?op=mostrar",{idmodulo : idmodulo}, function(data, status)
	{
...
function desactivar(idmodulo)
{
	bootbox.confirm("¿Está Seguro de desactivar la Categoría?", function(result){
		if(result)
        {
        	$.post("../ajax/modulos.php?op=desactivar", {idcategoria : idcategoria}, function(e){
        		bootbox.alert(e);
	            tabla.ajax.reload();
        	});	
        }
...
function activar(idmodulo)
{
	bootbox.confirm("¿Está Seguro de activar la Categoría?", function(result){
		if(result)
        {
        	$.post("../ajax/modulos.php?op=activar", {idcategoria : idcategoria}, function(e){
        		bootbox.alert(e);
	            tabla.ajax.reload();
        	});	
        }
