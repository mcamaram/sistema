                    ...
                    <div class="panel-body table-responsive" id="listadoregistros">
                        <table id="tbllistado" class="table table-striped table-bordered dt-responsive table-hover table-condensed" cellspacing="0" width="100%" style="background: white!important">
                          <thead>
                            ...
                            <th class="bg-primary">Presupuesto anual</th>
                    ...
                    <div class="panel-body" style="height: 400px;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input type="number" step="any" class="form-control" name="presupuesto_anual" id="presupuesto_anual" maxlength="15" placeholder="Presupuesto Anual...">
                          </div>
